export const m = {
  ...
  Training_Admin: 'Course',
  Training_List: 'Course List',
  Create_Training: 'Create Course',
  ...
  Password_Check_Length: 'Password length must be between 6-25 characters',
  ...
  Add_Problems_Failed: 'Add Problems Failed',
  Auth: 'Auth',
  ...
  View_Training_Problem_List: 'View Course Problem List',
  Delete_Training_Tips: 'This operation will delete the Course and its submission, rank record and other data. Do you want to continue?',

  // /views/admin/training/Training.vue
  Training_rank: 'Course Sort Number (Ascending Sort)',
  ...
  Public_Training: 'Public Course',
  Private_Training: 'Private Course',
  Training_Password: 'Course Password',
  Edit_Training: 'Edit Course',
  Redirect_To_Category: 'The category list of current Course is empty. Please go to create category first!',
  Redirect: 'Redirect',

  // /views/admin/training/TrainingProblemList.vue
  Training_Problem_List: 'Course Problem List',
  Add_Training_Problem: 'Add Course Problem',
  Remove_Training_Problem_Tips: 'Are you sure you want to remove the problem from the Course?',
