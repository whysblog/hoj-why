export const m = {
  ...
  Update_Time: '更新时间',
  Order_Number: '序号',
  View_Training_Problem_List: '查看课程题目列表',
  Delete_Training_Tips: '此操作将删除该课程提交记录、榜单等数据, 是否继续?',

  // /views/admin/training/Training.vue
  Training_rank: '课程排序编号(升序)',
  Training_Title: '课程标题',
  Training_Description: '课程描述',
  Training_Auth: '课程权限',
  Training_Category: '课程分类',
  Public_Training: '公开课程',
  Private_Training: '私有课程',
  Training_Password: '课程密码',
  Edit_Training: '编辑课程',
  Redirect_To_Category: '当前课程的分类列表为空，请先前往创建分类！',
  Redirect: '重定向',

  // /views/admin/training/TrainingProblemList.vue
  Training_Problem_List: '课程题目列表',
  Add_Training_Problem: '添加课程题目',
  Remove_Training_Problem_Tips: '你是否确定要将该题目移出课程？',
