export const m = {
  ...
  NavBar_Home: '首页',
  NavBar_Problem: '题目',
  NavBar_Programming_Problem: '编程题',
  NavBar_Objective_Quiz: '客观题',
  NavBar_Objective_Quiz_Paper: '客观题套卷',
  Quiz_Mode_Single: '单题',
  Quiz_Mode_Paper: '套卷',
  NavBar_Training: '课程',
  NavBar_Contest: '比赛',
  ...
  Profile_Edit_Forbidden: '对不起，您已被禁止修改个人资料！',
  Update_Failed: '更新失败',
  ...
  To_Enter_Contest_Need_Password: '请输入该比赛的密码，方可进入比赛',
  To_Enter_Training_Need_Password: '请输入该课程的密码，方可进入课程',
  Enter_the_contest_password: '请输入比赛密码',
  Enter_the_training_password: '请输入课程密码',
  Enter_the_password: '请输入密码',
  Please_enter_password: '请输入密码',
  Wrong_password: '密码错误',
  Cancel: '取消',
  Register_training_successfully: '课程报名成功',
  ...
  Search_Training: '搜索课程',
  Training_Public: '公开课程',
  Training_Private: '私有课程',
  Training_Category: '课程分类',
  Number: '编号',
  Problem_Number: '题目数',
  Recent_Update: '最近更新',
  Progress:'进度',
  ...
  Training_Introduction: '课程简介',
  Training_Number: '课程编号',
  Training_Auth: '课程权限',
  Training_Total_Problems: '总题数',
  Record_List: '记录榜单',
  To_Enter_Training_Need_Password: '请输入该私有课程的密码，方可进入',
  Enter_the_training_password: '请输入私有课程的密码',  
  Register_training_successfully: '验证课程密码成功！',
