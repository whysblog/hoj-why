export const m = {
  ...
  NavBar_Training_Home:'Course Home',
  ...
  Reset_Password_Email: 'Please enter your email or phone',
  Reset_Password_Captcha: 'Please Enter the captcha',
  Send_Password_Reset_Email: 'Send Password Reset Email',
  Send_Password_Reset_Msg: 'Send Password Reset Message',
  Waiting_Can_Resend_Email: 'resend the Reset Email...',
  Waiting_Can_Resend_Reset_Msg: 'resend the Reset Message...',
  ...
  ResetPwd_Send_Contact_Msg: 'Reset message has been sent. If you do not receive it for a long time, please check your email or phone.',
  Reset_Password_Contact_Required: 'Email or phone is required.',
  Reset_Password_Contact_Format: 'Please enter a valid email or phone.',
  Reset_Password_SMS_Code: 'Please enter SMS verification code',
  Reset_Password_By_Phone: 'Reset Password by SMS Code',
  ...
  Profile_Edit_Forbidden: 'Sorry, you are forbidden to edit your profile!',
  ...
  // /views/oj/rank/TotalRank.vue
  Total_Ranklist: 'Total Ranklist',
  ...
  To_Enter_Contest_Need_Password: 'To enter the Private contest, please input the password!',
  ...
  // /views/oj/trainingList.vue
  Search_Training: 'Search Course',
  ...
  Training_Introduction: 'Course Introduction',
  Training_Number: 'Number',
  Training_Auth: 'Course Auth',
  Training_Total_Problems: 'Total Problems',
  Record_List: 'Record List',
  To_Enter_Training_Need_Password: 'To enter the Private Course, please input the password!',
  Enter_the_training_password: 'Enter the Course password',
  Register_training_successfully: 'Register Course successfully',
