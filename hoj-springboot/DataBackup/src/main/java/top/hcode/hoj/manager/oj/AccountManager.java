...
public class AccountManager {
    ...
    public UserInfoVO changeUserInfo(UserInfoVO userInfoVo) throws StatusFailException {
        ...
        boolean canModifyProfile = true;
        if (roles != null) {
            for (Role role : roles) {
                // 1009: 禁止修改个人资料, 1010: 禁止修改个人资料&禁言
                if (role != null && role.getId() != null && 
                    (role.getId().equals(1009L) || role.getId().equals(1010L))) {
        ...
        if (!canModifyProfile) {
            throw new StatusFailException("对不起，您已被禁止修改个人资料！");
        }
